...
<script type="text/javascript">
		$(function(){
			var id = '<%=id%>';
			var options = {
				detailUrl:"hatInfo.do",
				submitUrl:"savehatInfo.do",
	...
	<div id="container">
		...
		<form action="" id="form" method="post">
			...
			<table border="0" cellpadding="0" cellspacing="0" class="form_table">
				...
				<tr>
					<td class="td_right">53：</td>
					<td><input type="text" id="a53" name="a53" value=""
						class="input_long" require="NotNull" /></td>
				</tr>
				<tr>
					<td class="td_right">54：</td>
					<td><input type="text" id="a54" name="a54" value=""
						class="input_long" require="NotNull" /></td>
				</tr>
				<tr>
					<td class="td_right">55：</td>
					<td><input type="text" id="a55" name="a55" value=""
						class="input_long" require="NotNull" /></td>
				</tr>
				<tr>
					<td class="td_right">56：</td>
					<td><input type="text" id="a56" name="a56" value=""
						class="input_long" require="NotNull" /></td>
				</tr>
				<tr>
					<td class="td_right">57：</td>
					<td><input type="text" id="a57" name="a57" value=""
						class="input_long" require="NotNull" /></td>
				</tr>
				<tr>
					<td class="td_right">58：</td>
					<td><input type="text" id="a58" name="a58" value=""
						class="input_long" require="NotNull" /></td>
				</tr>
				<tr>
					<td class="td_right">59：</td>
					<td><input type="text" id="a59" name="a59" value=""
						class="input_long" require="NotNull" /></td>
				</tr>
				<tr>
					<td class="td_right">60：</td>
					<td><input type="text" id="a60" name="a60" value=""
						class="input_long" require="NotNull" /></td>
				</tr>
			</table>
		</form>
