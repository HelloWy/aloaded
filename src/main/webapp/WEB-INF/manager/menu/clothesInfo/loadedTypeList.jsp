...
<script type="text/javascript">
	$(function() {
		var options = {
			returnUrl : "<%=path%>/clothesInfo/loadedtype.do",
			viewUrl : "loadedtypeList.do",
			colNames : [ "被装类别", "号型" ],
			colModels : [ {
				name : 'loadedtypename'
			}, {
			...
			operate : [ "modify", "delete" ], //操作状态
			addBtn : "btnAdd",
			openState : true,
			editorUrl : "msgInfoEditor.do",
			deleteUrl : "deleteTypeById.do",
			addUrl : "addMsgEditor.do",
			winWidth : 650,
			winHeight : 360,
			winPos : "c",
			winTitle : "当前窗口：回复信息"
	...
	<div class="rightinfo">
		<div class="tools">
			<ul class="toolbar" style="width: auto; float: left;">
				<li class="click" id="btnAdd" name="btnAdd"><span><img
						src="${loaded }/images/t01.png" /></span>添加</li>
			</ul>
			<ul class="toolbar1">
