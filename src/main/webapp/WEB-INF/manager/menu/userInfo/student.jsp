...
<script type="text/javascript">
	$(function() {
		var options = {
			viewUrl : "student.do",
			colNames : [ "学号", "姓名", "队部", "性别", "身高", "胸围", "腰围", "脚长" ],
			colModels : [ {
				name : 'studentId'
			}, {
				name : 'name'
		...
		<div class="tools">
            ...
            <li><span><img src="../../images/t04.png" /></span>统计</li>-->
				<form action="" id="searchFastForm" name="searchFastForm">
					<li class="selectInput"><label style="float: left;">单位<b>:</b>&nbsp&nbsp
					</label>
						<div class="vocation">
							<select class="select1" id="company" name="company">
