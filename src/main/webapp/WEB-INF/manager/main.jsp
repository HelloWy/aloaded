...
<frameset rows="88,*" cols="*" frameborder="no" border="0"
	framespacing="0">
	<frame src="<%=path%>/frame/top.do" name="topFrame" scrolling="no"
		noresize="noresize" id="topFrame" title="topFrame" />
	<frameset id="mainFrame" cols="187,*" frameborder="no" border="0"
		framespacing="0">
		<frame src="<%=path%>/frame/left.do" name="leftFrame" scrolling="no"
			noresize="noresize" id="leftFrame" title="leftFrame" />
		<frame src="<%=path%>/userInfo/stu.do" name="rightFrame"
